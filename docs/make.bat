...
REM This file is part of dartt

REM dartt is free software: you can redistribute it and/or modify it under the
...
REM along with dartt. If not, see <https://www.gnu.org/licenses/>.
